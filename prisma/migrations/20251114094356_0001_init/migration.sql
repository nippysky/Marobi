...
CREATE TABLE "SizeChartEntry" (
    ...
    "hipMin" INTEGER NOT NULL,
    "hipMax" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "SizeChartEntry" ADD CONSTRAINT "SizeChartEntry_chartId_fkey" FOREIGN KEY ("chartId") REFERENCES "SizeChart"("id") ON DELETE CASCADE ON UPDATE CASCADE;
